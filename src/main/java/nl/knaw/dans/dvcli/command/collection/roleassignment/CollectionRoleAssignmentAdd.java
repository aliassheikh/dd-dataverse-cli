...
public class CollectionRoleAssignmentAdd extends AbstractRoleAssignmentSubcommand<CollectionCmd, DataverseApi> {
    @ParentCommand
    ...
    private static class AddAssignmentAction implements ThrowingFunction<RoleAssignmentParams<DataverseApi>, String, Exception> {
        @Override
